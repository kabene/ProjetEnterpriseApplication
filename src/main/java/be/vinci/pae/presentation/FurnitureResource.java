...
public class FurnitureResource {
   ...
   * @return http response containing a piece of furniture in json format (or relevant status code
   * in if error)
   */
  @GET
  @Path("/{id}")
   ...
   *
   * @return http response containing a list of pieces of furniture in json format (or relevant
   * status code in if error)
   */
  @GET
  @Path("/detail")
  @Admin
