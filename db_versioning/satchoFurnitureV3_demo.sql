...
INSERT
INTO satchoFurniture.furniture (seller_id, status, description, type_id)
VALUES (4, 'accepted', 'Bahut profond d’une largeur de 112 cm et d’une hauteur de 147 cm.', 2);

INSERT
INTO satchoFurniture.furniture (seller_id, status, description, type_id)
VALUES (4, 'accepted', 'Large bureau 1m87 cm, deux colonnes de tiroirs', 6);

INSERT
INTO satchoFurniture.furniture (seller_id, status, description, type_id)
VALUES (4, 'refused', 'Table jardin en bois brut', 21);


INSERT
INTO satchoFurniture.furniture (seller_id, status, description, type_id)
VALUES (5, 'accepted', 'Table en chêne, pieds en fer forgé', 21);

INSERT
INTO satchoFurniture.furniture (seller_id, status, description, type_id)
VALUES (5, 'accepted', 'Secrétaire en acajou, marqueterie', 20);
